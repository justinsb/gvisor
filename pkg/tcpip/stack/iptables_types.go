...
func (fl IPHeaderFilter) match(pkt *PacketBuffer, hook Hook, inNicName string, outNicName string) bool {
...
type Matcher interface {
	...
	Match(hook Hook, packet *PacketBuffer, inputInterfaceName string, outputInterfaceName string) (matches bool, hotdrop bool)
}
