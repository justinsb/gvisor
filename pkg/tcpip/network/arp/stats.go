...
type multiCounterARPStats struct {
	...
	outgoingRequestNetworkUnreachableErrors         tcpip.MultiCounterStat
...
func (m *multiCounterARPStats) init(a, b *tcpip.ARPStats) {
	...
	m.outgoingRequestNetworkUnreachableErrors.Init(a.OutgoingRequestNetworkUnreachableErrors, b.OutgoingRequestNetworkUnreachableErrors)
